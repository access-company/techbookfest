...
このようなコメントは、発表者のメンタルを壊し、チームに鬱憤をため、やる気の低下を引き起こします。
...
その中で試験のようなレビューをすると、発表者はユーザーではなくレビュアーの満足度を高くすることに注力したり、試験に合格することが目的と錯覚します。
...
ですが、一貫性を損ないすぎている場合、発表者が理不尽さを感じ、鬱憤を溜めたりやる気の低下を引き起こしかねません。
...
1つめは、建設的なフィードバックがあり、健全で活発な議論を生むことです。コメントを書く人は、自分の考えを明確にしつつ、それが正しいものだとは主張しません。状況に応じていろんな代替案や回避策が存在することを認め、修正の強要ではなく、どう思う？などと問いかけます。もしレビュイーから反対意見が出た場合は、インターネットや先人の知恵に寄り道して、2人の間でいい着地点を探しましょう。それが難しそうなら、第三者に客観的な意見を求めるのがよいでしょう。

2つめは、レビュアーがレビュイーに共感していることです。いかなる方法でも、レビュイーが実装にかけた時間や労力を称賛し、強い口調ではなく親切で控えめな口調で接することが大切です。たくさんコメントした場合は、プルリクエスト以外の場所、例えば対面やオンライン会議、チャットやメールなどで積極的に連絡を取り、誤解が生じることを防ぎます。そうすればきっとつらい思いをする人は減り、レビューの雰囲気や会話の方向性がとてもポジティブなものとなるでしょう。
